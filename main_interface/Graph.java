...
public class Graph extends JPanel{
    ...
    public void paint(Graphics g){
     ...
     public void Draw_Graph(Graphics2D GG){
       try{
           ...
           Y_max = this.getHeight()-this.getHeight()/30;
           X_min=this.getWidth()/30;
           Y_min=this.getHeight()/30;
           ...
           int k=0;
           for (double i = (int) P_Ymin; i <= (int) P_Ymax; i=i+Y_dif) {
           ...
           for (double i = (int) P_Ymin; i <= (int) P_Ymax; i=i+Y_dif) {
               ...
               }else if(this.Z_Flag==true){
                   GG.drawString(""+myFormat.format(i),(int)X_min, (int)(y1));
               }
           }
           ...
           GG.setStroke(new BasicStroke(2.0f));
            ...
            for(int i=1;i<=DN;i++){
                 ...
                 if(Q_Flag==true){
                      GG.drawString(D_String[i]+"  "+(int)P_Ymax_Str[i]+"㎥/s", x1, y1);
                 }else if(Z_Flag==true){
                      GG.drawString(D_String[i]+": "+myFormat.format(P_Ymax_Str[i])+"m", x1, y1);
                 }
            }          
           ...
           if(Z_Flag==true){
               ...
               GG.setStroke(dashed);
               GG.setColor(new Color(150,0,0));
               x1 = (int)( X_min);
               y1 = (int) ((Y_max - (NormalZ - P_Ymin) / Y_rate));
               x2 = (int) (X_max);
               y2 = (int) ((Y_max - (NormalZ - P_Ymin) / Y_rate));
               GG.drawLine((int) (x1), (int) (y1), (int) (x2),
                           (int) (y2));
               GG.drawString("▽Z_Normal= "+NormalZ+"m",(int)(X_max*0.5),(int)(y1));
               GG.setColor(Color.red);
               x1 = (int)( X_min);
               y1 = (int) ((Y_max - (FloodZ - P_Ymin) / Y_rate));
               x2 = (int) (X_max);
               y2 = (int) ((Y_max - (FloodZ - P_Ymin) / Y_rate));
               GG.drawLine((int) (x1), (int) (y1), (int) (x2),
                           (int) (y2));
               GG.drawString("▽Z_Flood= "+FloodZ+"m",(int)(X_max*0.3),(int)(y1)); 
               GG.setColor(Color.black);
               x1 = (int)( X_min);
               y1 = (int) ((Y_max - (BondZ - P_Ymin) / Y_rate));
               x2 = (int) (X_max);
               y2 = (int) ((Y_max - (BondZ - P_Ymin) / Y_rate));
               GG.drawLine((int) (x1), (int) (y1), (int) (x2),
                           (int) (y2));
               GG.drawString("▽Z_Bond= "+BondZ+"m",(int)(X_max*0.5),(int)(y1));
               GG.setColor(Color.BLUE);
               x1 = (int)( X_min);
               y1 = (int) ((Y_max - (DieZ - P_Ymin) / Y_rate));
               x2 = (int) (X_max);
               y2 = (int) ((Y_max - (DieZ - P_Ymin) / Y_rate));
               GG.drawLine((int) (x1), (int) (y1), (int) (x2),
                           (int) (y2));
               GG.drawString("▽Z_Die= "+DieZ+"m",(int)(X_max*0.5),(int)(y1));
               GG.setColor(Color.DARK_GRAY);
               x1 = (int)( X_min);
               y1 = (int) ((Y_max - (Gate_Sill - P_Ymin) / Y_rate));
               x2 = (int) (X_max);
               y2 = (int) ((Y_max - (Gate_Sill - P_Ymin) / Y_rate));
               GG.drawLine((int) (x1), (int) (y1), (int) (x2),
                           (int) (y2));
               GG.drawString("▽Z_Sill= "+Gate_Sill+"m",(int)(X_max*0.7),(int)(y1));       
               
           }
 
           SelString=MFrame.Reservoir[1].Mth[SelN] + ":" + 
                     MFrame.Reservoir[1].Dy[SelN] + ":" + 
                     MFrame.Reservoir[1].Time[SelN];
           for(int i=1;i<=DN;i++){
                ...
                GG.setColor(Color.black);
                //GG.drawString(SelString,x1+(int)(X_max-X_min)/30,y1);
                if(this.RedFlag==true){
                    GG.drawString("Q="+(int)G_Y[i][SelN]+"㎥/s",x1+(int)(X_max-X_min)/30,y1);
                }else if(this.BlueFlag==true){
                    GG.drawString("Z="+myFormat.format(G_Y[i][SelN])+"m",x1+(int)(X_max-X_min)/30,y1);
                }               
           }
    ...
    private void jbInit() throws Exception {
        ...
        this.addMouseMotionListener(new Graph_this_mouseMotionAdapter(this));
    }
    int MX,MY;
...
class Graph_this_mouseMotionAdapter extends MouseMotionAdapter {
    private Graph adaptee;
    Graph_this_mouseMotionAdapter(Graph adaptee) {
